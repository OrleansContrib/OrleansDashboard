...
namespace PerformanceTests
{
    public class ManualTests
    {
        ...
        private readonly ITraceHistory history2 = new TraceHistoryV2(HistorySize);
        ...
        private void Test(string name, Action<ITraceHistory> action)
        {
            ...
            Console.WriteLine("{0} V2: {1}", name, watch.Elapsed / NumIterations);
            Console.WriteLine();
        }
    }
}
