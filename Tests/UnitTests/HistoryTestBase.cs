...
namespace UnitTests
{
    public abstract class TraceHistoryTestBase
    {
        ...
        private void Add(ITraceHistory history, int count)
        {
            ...
            {
                history.Add(startTime.AddSeconds(seconds), "SILO1", new[]
                {
                ...
                history.Add(startTime.AddSeconds(seconds), "SILO2", new[]
                {
                    new SiloGrainTraceEntry 
                    {
                        Grain = "GRAIN1",
        ...
        protected abstract ITraceHistory CreateHistory();
